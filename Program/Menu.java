...
public class Menu extends javax.swing.JFrame {
    ...
    public Menu() {
        ...
        // Dummy
        mahasiswaList.add(new Mahasiswa("2108921", "Muhammad Fahru Rozi","C1","Laki-Laki", "A"));
        mahasiswaList.add(new Mahasiswa("2108922", "Chelsea Islan","C2","Perempuan", "B"));
    ...
    public final DefaultTableModel setTable() {
        // Column Title
        Object[] column={"NIM", "Nama", "Kelas", "Gender", "Nilai"};
        DefaultTableModel dataTabel = new DefaultTableModel(null,column);
        
        // Get Cell Value
        for(int i=0;i<mahasiswaList.size();i++){
            Object[] row = new Object[5];
            row[0] = mahasiswaList.get(i).getNim();
            row[1] = mahasiswaList.get(i).getNama();
            row[2] = mahasiswaList.get(i).getKelas();
            row[3] = mahasiswaList.get(i).getGender();
            row[4] = mahasiswaList.get(i).getNilai();
    ...
    public void insertData() {
        ...
        String kelas = fieldKelas.getSelectedItem().toString();
    ...
    private void initComponents() {
        ...
        fieldGender.setModel(new javax.swing.DefaultComboBoxModel<>(new String[] { "Laki - laki", "Perempuan" }));
                    ...
                    .addGroup(jPanel1Layout.createSequentialGroup()
                        .addGroup(jPanel1Layout.createParallelGroup(javax.swing.GroupLayout.Alignment.LEADING)
                            ...
                            .addGroup(jPanel1Layout.createSequentialGroup()
                                ...
                                .addGap(33, 33, 33)
                                .addGroup(jPanel1Layout.createParallelGroup(javax.swing.GroupLayout.Alignment.LEADING, false)
                                    .addComponent(fieldKelas, 0, javax.swing.GroupLayout.DEFAULT_SIZE, Short.MAX_VALUE)
